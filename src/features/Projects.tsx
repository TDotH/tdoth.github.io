...
function Projects({
  ...
  return (
    <section
      ...
      id={sectionName}
      className={
        "w-full flex flex-col items-center " + (className ? className : "")
      }
    >
      <div className="w-full">
        <h2 className="text-6xl max-w-7xl mx-auto font-bold text-foreground lg:mb-4 p-4 md:p-6 ">
          Projects
        </h2>
      </div>
        ...
        <article className="p-2 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[repeat(4,300px)] place-items-center gap-5 mx-2">
            {currentProjects?.length !== 0 ? (
              ...
              <div className="w-full text-2xl mt-6 col-span-4 text-center">
